    ...
    <div class="login-card">
        ...
        <form method="POST" action="" id="loginForm" onsubmit="return validateForm()">
            ...
            <div class="demo-credentials">
                ...
                <p><strong>Admin:</strong> <code>admin@fleetflow.com</code> / <code>password123</code></p>
                <p><strong>Driver:</strong> <code>john.driver@fleetflow.com</code> / <code>password123</code></p>
                <p><strong>Passenger:</strong> <code>alice@email.com</code> / <code>password123</code></p>
            </div>
        </form>
    </div>
</div>
...
function fillDemoCredentials(role) {
    const credentials = {
        admin: { email: 'admin@fleetflow.com', password: 'password123' },
        driver: { email: 'john.driver@fleetflow.com', password: 'password123' },
        passenger: { email: 'alice@email.com', password: 'password123' }
    };
